...
if st.session_state.user_name == "vishakha":
    ...
    with response_container:
        for i, (query, answer, feedback) in enumerate(st.session_state.chat_history):
            ...
            col1, col2, col3 = st.columns([0.3, 0.1, 10])  # Added a new column col3 for thumbs buttons
            with col1:
                st.image("icon-1024.png", width=50)
            with col3:  # Place the answer in col3
                st.markdown(
            ...
            with col2:  # Place the thumbs buttons in col2
