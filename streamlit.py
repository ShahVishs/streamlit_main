...
if st.session_state.user_name == "vishakha":
    ...
    template = (
        ...
        Before scheduling, inquire about car trade-in. Ask for name, contact number, and email separately. If they ask for resheduling then provide the answer by checking the availability and also provide a link
