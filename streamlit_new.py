...
# Use st_autorefresh where you want autorefresh behavior
...
# Use st_autorefresh to trigger autorefresh
count = st_autorefresh(interval=secs * 1000, limit=100, debounce=should_debounce, key="fizzbuzzcounter")

# The function returns a counter for the number of refreshes. Use the count as needed.
if count == 0:
